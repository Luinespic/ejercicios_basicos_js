//1. Define tu superhéroe favorito: Crea una variable llamada miSuperheroeFavorito y asigna el valor "Hulk".

let miSuperheroeFavorito = "Hulk";

//2. Define un número: Crea una variable llamada numeroFavorito y asigna el valor 50.
